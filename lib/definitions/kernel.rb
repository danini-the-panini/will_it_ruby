...
module Gemologist
  Definition.add_class_definition(BasicObject) do
    ...
    # add_method_definition :BigDecimal, [Real | T(String), !T(Integer)] => T(BigDecimal) # TODO: requires BigDecimal
    ...
    # add_method_definition :Pathname, T(String) => T(Pathname) # TODO: requires pathname
    ...
    # add_method_definition :callcc, T, T(Continuation) => T # TODO: requires Continuation
    ...
    add_method_definition :fail, [T(Exception), !T(String), !T(Array, String)] => Nil
    ...
    add_method_definition :raise, [T(Exception), !T(String), !T(Array, String)] => T(Exception)
    ...
    add_method_definition :untrace_var, [T(Symbol), T(String) | T(Proc)] => T(Array, Proc) | Nil
